...
import { canSwitchShop } from './role-capabilities';
...
export class AuthService {
  ...
  async login(dto: LoginDto) {
    ...
    const activeShopId = canSwitchShop(user.role) ? undefined : user.shopId;
  ...
  async selectShop(userId: string, shopId: string) {
    ...
    this.shopScopeService.assertAccess(
  ...
  async refresh(refreshToken: string) {
    try {
      ...
      let activeShopId = canSwitchShop(user.role)
  ...
  private isValidTokenPayload(
    payload: Partial<AuthTokenPayload> | null | undefined,
